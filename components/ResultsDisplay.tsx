...
export const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ result }) => {
  return (
    <div className="bg-slate-800/60 border border-slate-700 rounded-lg shadow-lg animate-fade-in">
        <div className="p-6">
            <h2 className="text-2xl font-bold text-white text-center">Analysis Report</h2>
        </div>
        <div className="p-6 border-y border-slate-700 flex flex-col md:flex-row items-center gap-6">
            ...
            {result.adMatchAnalysis && (
                 <div className="bg-slate-800 p-4 rounded-lg md:col-span-2">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold text-white bg-cyan-500/20 text-cyan-300 px-2 py-1 rounded-full">{result.adMatchAnalysis.score}/100</span>
                    </div>
